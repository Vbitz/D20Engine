...
function createCommoner(ctx) {
    ...
    // dynamically.
    ent.addComponent(new Fifth.Creature.template({
    ...
    ent.addComponent(
        new Fifth.Monster.template({ challenge: Fifth.Challenge.Zero }));

    const clubAction = 'club';

    ent.addComponent(new Fifth.MeleeAttackAction.template({
        name: clubAction,
        hitBonus: 2,
        reach: 5,
    ...
    ent.addComponent(new Fifth.BasicMonsterAI.template({ action: [clubAction] }));
